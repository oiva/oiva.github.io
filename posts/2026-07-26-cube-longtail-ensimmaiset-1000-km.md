...
status: publish
layout: post
title: "Cube Longtail - ensimmäiset 1&nbsp;000&nbsp;km"
language: fi
date: 2026-07-26 13:33:33
date_gmt: 2026-07-26 10:33:33
excerpt: Päivitetty arvio Cube Longtail Hybridistä ensimmäisten 1 000 km jälkeen
tags:
- polkupyörä
- pyöräily
---
...
Hankin Cube Longtail *pitkäperäpyörän* [vuosi sitten keväällä](2025/04/02/cube-longtail:-pika-arvio/). Pyörä kerkesi työsuhdepyöräksi kuukausi ennen kuin työsuhdepyörien verotuki lopetettiin. Kilometrejä ei ole kertynyt hurjasti, koska ajot ovat lähinnä lasten kuskaamista päiväkotiin ja pari kertaa viikossa toimistolle. Mutta *se on mitä se on*.

<figure>
  <a href="/images/2026/cube-longtail-penkki.jpg">
    <img src="/images/2026/cube-longtail-penkki.jpg" alt="Lapsi istumassa Cube Longtailin tarakalla. Tarakan yläpuolella on metallikehä, josta voi pitää käsillä kiinni" height="720" loading="lazy">
  </a>
  <figcaption>Cube Longtail tarakkaistuin. Lastenistuin tulee kuvassa näkyvän jousen päälle</figcaption>
</figure>
...
Päällimmäisenä huomiona: pyörä on ollut hyvä lisä perheen kuljetus&shy;tarpeisiin. Lapset on tosi kätevä heittää tarakalle ja hurauttaa päiväkotiin (n.&nbsp;1,5&nbsp;km). Kaikki muut vaihtoehdot, auto, bussi, kävely, ovat hitaampia. Töihin mennessä (n.&nbsp;6&nbsp;km) pyörä on yhtä nopea kuin auto.
...
Samaten takavaihtaja on todella vaikea saada säädettyä kohdilleen. Ehkä pitkä vaijeri&shy;veto elää sen verran? Kalliimman mallin hihna&shy;veto ja napa&shy;vaihde voi olla parempi, mutta haaveilen silloin tällöin sähkövaihteista.
...
<figure>
  <a href="/images/2026/cube-longtail-tarakka.jpg">
    <img src="/images/2026/cube-longtail-tarakka.jpg" alt="Cube Longtail -pyörän tarakka, jossa kaksi lastenistuinta. Taemman lastenistuimen takana on vielä n. 10 cm tilaa" height="640" loading="lazy">
  </a>
  <figcaption>Kaksi istuinta tarakalla. Taempi istuin jää suhteellisen eteen. Lapset ovat kuvassa väärin päin: isomman lapsen on parempi olla etupenkillä, että painopiste pysyy keskemmällä.</figcaption>
</figure>
